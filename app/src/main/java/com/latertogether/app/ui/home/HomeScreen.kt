...
import com.latertogether.app.ui.shell.AppShell
import com.latertogether.app.viewmodel.HomeEvent
import com.latertogether.app.viewmodel.HomeViewModel
import com.latertogether.app.viewmodel.HomeViewModelFactory
    ...
    AppShell(onComingSoon = onComingSoon, snackbarHostState = snackbarHostState) {
        if (uiState.isEmpty) {
            ...
            HomeSessionList(
                ...
                onRemoveSession = vm::onRemoveSession,
                modifier = modifier,
            )
        }
    }
